...
public class AdminPanel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        updateButton.setFont(new java.awt.Font("Cambria", 0, 18)); // NOI18N
        ...
        updateButton.setBounds(20, 0, 113, 50);

        checkStockButton.setBackground(new java.awt.Color(0, 153, 204));
        checkStockButton.setFont(new java.awt.Font("Cambria", 0, 18)); // NOI18N
        ...
        jPanel4.add(checkStockButton);
        checkStockButton.setBounds(150, 0, 137, 50);

        billingButton.setBackground(new java.awt.Color(0, 153, 204));
        billingButton.setFont(new java.awt.Font("Cambria", 0, 18)); // NOI18N
        ...
        jPanel4.add(billingButton);
        billingButton.setBounds(290, 0, 137, 50);

        jPanel3.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 1200, 50));
        ...
        stockStatusCat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Wearables", "SportsItems", "Equipments" }));
        ...
        delUpdateCat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Wearables", "SportsItems", "Equipments" }));
        ...
        mBrand.setFont(new java.awt.Font("Cambria", 0, 14)); // NOI18N
        ...
        updatePanel.add(mBrand, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 110, 410, -1));

        mModel.setFont(new java.awt.Font("Cambria", 0, 14)); // NOI18N
        ...
        updatePanel.add(mModel, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 150, 410, -1));
        ...
        mQty.setFont(new java.awt.Font("Cambria", 0, 14)); // NOI18N
        ...
        updatePanel.add(mQty, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 230, 410, -1));
        ...
        mPhotoPath.setFont(new java.awt.Font("Cambria", 0, 14)); // NOI18N
        ...
        mCat.setFont(new java.awt.Font("Cambria", 0, 14)); // NOI18N
        mCat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Wearables", "SportsItems", "Equipments" }));
        updatePanel.add(mCat, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 270, 150, -1));

        mDescription.setColumns(20);
        mDescription.setFont(new java.awt.Font("Cambria", 0, 14)); // NOI18N
        ...
        updatePanel.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 320, 410, 190));
        ...
        photoSelection.setBackground(new java.awt.Color(0, 204, 204));
        ...
        mPrice.setFont(new java.awt.Font("Cambria", 0, 14)); // NOI18N
        ...
        updatePanel.add(mPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 190, 410, -1));
        ...
        updatePanel.add(LogInButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 450, 130, 50));
        ...
        checkStockPanelLayout.setHorizontalGroup(
            ...
            .addGroup(checkStockPanelLayout.createSequentialGroup()
                .addComponent(updatePanel, javax.swing.GroupLayout.PREFERRED_SIZE, 1190, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(38, 38, 38)
        ...
        checkStockPanelLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, checkStockPanelLayout.createSequentialGroup()
                ...
                .addComponent(updatePanel, javax.swing.GroupLayout.PREFERRED_SIZE, 575, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    private void billingButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_billingButtonMouseReleased
        // TODO add your handling code here:
        billingButton.setBackground(new Color(0, 153, 204));
    ...
    private void checkStockButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkStockButtonActionPerformed
            ...
            ArrayList<ProductList> list = WearablesDB.checkStock();
    ...
    private void checkStockButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_checkStockButtonMouseReleased
        // TODO add your handling code here:
        checkStockButton.setBackground(new Color(0, 153, 204));
    ...
    private void LogInButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LogInButtonActionPerformed
        // TODO add your handling code here:
        try{
            if(mCat.getSelectedItem().equals("SportsItems")){
            if(!path.equals(""))
                SportsItemsDB.insertIntoSportsItemsDB(mBrand.getText(), mModel.getText(), Integer.parseInt(mPrice.getText()), 
                        Integer.parseInt(mQty.getText()), mDescription.getText(), path);
        }
        
        else if(mCat.getSelectedItem().equals("Wearables")){
            if(!path.equals(""))
                WearablesDB.insertIntoWearablesDB(mBrand.getText(), mModel.getText(), Integer.parseInt(mPrice.getText()), 
                        Integer.parseInt(mQty.getText()), mDescription.getText(), path);
        }
        else if(mCat.getSelectedItem().equals("Equipments")){
            if(!path.equals(""))
                EquipmentsDB.insertIntoEquipmentsDB(mBrand.getText(), mModel.getText(), Integer.parseInt(mPrice.getText()), 
                        Integer.parseInt(mQty.getText()), mDescription.getText(), path);
        }
    ...
    private void updateStockButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateStockButtonActionPerformed
       ...
       try{
            ...
            if(stockStatusCat.getSelectedItem().equals("Wearables")){
                WearablesDB.flag = true;
                WearablesDB.updateWearablesDB(model, qty);
            }

            else if(stockStatusCat.getSelectedItem().equals("SportsItems")){
                SportsItemsDB.flag = true;
                SportsItemsDB.updateSportsItemsDB(model, qty);
            }

            else if(stockStatusCat.getSelectedItem().equals("Equipments")){
                EquipmentsDB.flag = true;
                EquipmentsDB.updateEquipmentsDB(model, qty);
            }
    ...
    private void delEntryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delEntryActionPerformed
        ...
        if(delUpdateCat.getSelectedItem().equals("Wearables")){
            WearablesDB.delete(del);
        }
        else if(delUpdateCat.getSelectedItem().equals("SportsItems")){
            SportsItemsDB.delete(del);
        }
        else if(delUpdateCat.getSelectedItem().equals("Equipments")){
            EquipmentsDB.delete(del);
        }
