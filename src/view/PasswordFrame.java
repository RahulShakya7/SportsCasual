...
public class PasswordFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getPasswordButton.setBackground(new java.awt.Color(0, 153, 204));
        getPasswordButton.setFont(new java.awt.Font("Cambria", 0, 18)); // NOI18N
        ...
        closeButton.setBackground(new java.awt.Color(0, 153, 204));
    ...
    private void getPasswordButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_getPasswordButtonActionPerformed
        try {
            ...
            DbConnection.passRecovery(usernameField.getText());
